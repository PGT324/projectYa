...
public class UsersVO {
	...
	public UsersVO(int users_idx,String email,String pw,String phone,String nickname,String image,String agree_type_idx,int users_check,int status, int point, int use) {
