				...
				<div align="center" class="d1">
				 	<div class="d2">
				 		...
				 		<div style=" margin-bottom: 2.5%;">
				 			<a onclick="console.log('hi')"><b>${login.nickname }</b><br><font color="gray">${login.email }</font></a>
				 		</div>
				 	</div>
				 	...
				 	<div align="left" class="d2" style=" cursor: pointer;" onclick="document.location.href = '${pageContext.request.contextPath}/users/joinOut?users_idx=${login.users_idx }'">
