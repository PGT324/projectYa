            ...
            <div class="main">
                    ...
                    <div class="user-tab">
                        <div class="user-info">
                            <div class="user-infol">
                                ...
                                <div class="seller-icon" title="야놀자 사업자 인증 계정">
                                    &#128184;
                                </div>
                            </div>
                ...
                <div class="main-tops">
                    <div class="inven">
                        <div class="inven-top">
                            <div class="point">
                                <a href="/pro/mypage/point?users_idx=${login.users_idx }">
                                    <div class="point-one">
                            ...
                            <div class="coupon">
                                <a href="/pro/users/mypage/coupon?users_idx=${login.users_idx }">
                        ...
                        <div class="inven-bot">
                            <div class="review">
                                <a href="/pro/review/myreview?users_idx=${login.users_idx }">
                ...
                <div class="main-mid">
                    ...
                    <div class="reserv">
                        <div class="rslist">사업자 등록해지</div>
                        
                    </div>
                    <div class="reserv-one">
                        <a href="/pro/out">
                            <div class="reserv-two">사업자 해지신청</div>
                            <div class="reserv-thr">
                                <img src="https://yaimg.yanolja.com/joy/sunny/static/images/my/icon-arrow-small-black.svg">
                            </div>
                        </a>
                ...
                <div class="main-foot">
                    ...
                    <%-- <div class="reserv-one">
                        <a  onclick="window.open('${pageContext.request.contextPath}/users/chat','window_name','width=430,height=500,location=no,status=no,scrollbars=yes')";>
