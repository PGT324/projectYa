        ...
        <body>
            <header class="header">
                <div class="inner">
                    <div class="hd-in">
                        <div class="hd-left">
                            <img src="https://business.yanolja.com/common/kr/web/img/icon-home.png"> > 마이페이지 > 사업자 해지신청
                        </div>
                    </div>
                </div>
                <div class="title">
            ...
            <div class="main">
                <form action="/pro/outseller" method="post">
                    <div class="minfo">
                        <div class="mi-one">
                            <div class="mi-name">
                    ...
                    <div class="main-check">
                        ...
                        <div class="check-list">
                            <div class="cl-one">
                                ...
                                <label for="check1"><span class="ch-sp">&#40;필수&#41; </span>개인정보 수집 및 이용내역을 삭제합니다.</label>
                            </div>
                            <div class="cl-two">
                                <input type="checkbox" id="check1">
