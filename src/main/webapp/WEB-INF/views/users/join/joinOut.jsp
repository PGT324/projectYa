		...
		<div class="d1">
			<div style="margin-top: 3%;" class="d2">
				...
				<div style=" background-color: #E8E8E8;  border-radius: 6px; margin-bottom: 7%;">
					...
					<div align="right" style="margin-right: 5%; padding-bottom: 2%;"><b>${point } P</b></div>
				</div>
				...
				<form action="${pageContext.request.contextPath }/secession/joinout">
					<div>
						...
						<div style="margin-top: 1.5%; margin-left: 5%;  "><textarea name = "text" disabled="disabled" class="text" cols="70" rows="5" placeholder="탈퇴사유 직접입력" style="font-size: 17px; width: 100%; height: 6.25em; border: 1; resize: none"></textarea></div>
