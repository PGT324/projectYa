                     ...
                     <div align="center">
						<c:forEach var="vo" items="${list }">
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-body">
							    <input type="button" value="리뷰작성" onclick="document.location.href='/pro/review/motelinput?m_region1_idx=${vo.m_region1_idx}&m_region2_idx=${vo.m_region2_idx }&motel_idx=${vo.motel_idx }&m_room_idx=${vo.m_room_idx }&m_res_idx=${m_res_idx }'">
							  </div>
							</div>
							</c:forEach>
					</div>
