                     ...
                     <div align="center">
						...
						<c:forEach var="vo" items="${list}" varStatus="status">
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-body">
							    <input type="button" value="객실정보 확인하기" onclick="document.location.href='/pro/res/hotelroominfo?h_region1_idx=${vo.h_region1_idx}&h_region2_idx=${vo.h_region2_idx }&hotel_idx=${vo.hotel_idx }&h_room_idx=${vo.h_room_idx }&h_res_idx=${vo.h_res_idx }'">
							  </div>
							  <c:choose>
							  <c:when test="${check == 1 }">
							  <div class="card-body">
							    <input type="button" value="예약 취소하기" onclick="document.location.href='/pro/hdelete?users_idx=${login.users_idx}&h_res_idx=${vo.h_res_idx }'">
							  </div>
							  </c:when>
							  <c:otherwise>
							  <div class="card-body">
