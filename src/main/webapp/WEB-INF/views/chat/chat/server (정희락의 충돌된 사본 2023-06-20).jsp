...
<body>
	...
	<div id = "chatout" align="center">
		<div id = "${list[0].users_idx  }" class="list" align="left" onclick="serverin(this)">
			<div  class="listpc">
				<img src="https://yaimg.yanolja.com/joy/sunny/static/images/my/img-my-profile-50.svg">
				이름
			</div>
			<div style="margin-left: 2%;">
				방 번호: ${list[0].users_idx }<br> ${list[0].lastContent }
			</div>
			<div align="right">
				${list[0].lastDate }
			</div>
...
<script type="text/javascript">
		...
		success: function sc(s) {
			...
			for(var i = 0; i < aetChat.length; i++){
				...
				if(aetChat[i].idx == 0 && lastIdx == null || lastIdx != null && lastIdx != aetChat[i].idx && aetChat[i].idx == 0){
					...
					lastIdx = aetChat[i].idx;
					html = '<div class="other"><div class="other-dp"><div class="ot-pic"><img src="https://yaimg.yanolja.com/joy/sunny/static/images/my/img-my-profile-50.svg"></div> <div class="ot-name">'+"유저 이름"+'</div></div><div class="chat"><div class="ex-one">'+aetChat[i].content+'</div>'
	...
	sock.onopen = (evn) => {
		console.log("채팅참여")
		sock.send("&key"+${list[0].users_idx});
	}
	function sendMessage() {
	    sock.send($("#message").val()+"&|&"+0+"&key"+${list[0].users_idx }); 
	}
